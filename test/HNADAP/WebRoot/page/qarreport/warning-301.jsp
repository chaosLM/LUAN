...
String airportType_NAME = request.getParameter("airportType_NAME");//机场类型
String airportId_NAME = request.getParameter("airportId_NAME");//机场id
String specialAptType_NAME = request.getParameter("specialAptType_NAME");//特殊机场
...
<body>
    ...
    <input type="hidden" name="airportType_NAME" id ="airportType_NAME" value="<%=airportType_NAME %>">
    <input type="hidden" name="airportId_NAME" id ="airportId_NAME" value="<%=airportId_NAME %>">
    <input type="hidden" name="specialAptType_NAME" id ="specialAptType_NAME" value="<%=specialAptType_NAME %>">
		...
		<div class="warning-content warning-pilot">
			...
			<!-- 触发警告事件趋势 begin -->
				<div class="warning-event">
					<h3>
						...
						<span><i class='alert-pilot-name'></i>&nbsp;&nbsp;全部警告事件构成分析</span>	
					</h3>
			...
			<!-- 触发警告次数趋势 begin -->
				<div class="warning-times">
					<h3>
						...
						<span><i class='alert-pilot-name'></i>&nbsp;&nbsp;<b class="chart-alertId"></b>触发警告次数趋势分析</span>						
					</h3>
			...
			<!-- 触发警告千次数趋势 begin -->
				<div class="warning-rate">
					<h3>
						<img src="page/qarreport/images/warning-h3-img.png" alt="">
						<span><i class='alert-pilot-name'></i>&nbsp;&nbsp;<b class="chart-alertId"></b>触发警告千次数趋势分析</span>	
					</h3>
...
<script type="text/javascript">
	...
	seajs.use('warning', function(warning) {
		var reportParams = {
			orgId: $("#orgId").val(), dateType: $("#dateType").val(), dateId: $("#dateId").val(), airportType: $("#airportType").val(),  airportId: $("#airportId").val(), specialAptType: $("#specialAptType").val(),
		...
		warning({
			...
			columns:[
			        ...
			        {name:'alert_rate_cmprbl',className:'border-color-blue',call:function(e){
				        if (!e){
	                		return 0 + '%';
	                	}else{
	                		return Math.ceil(e * 100) + '%'; 
                ...
                tableHeadDom: [ // 表头设置
                    {
						 ...
						 html: '<th width="120" rowspan="2" class="dark-blue"><div class="pilot-team">机场</div></th>'+
